...
// если сумма к оплате превышает количество кредитов на счету, выводи
// в консоль сообщение 'Недостаточно средств на счету!'.
...
const shop = prompt('Скільки купляєте друїдів?');

if (shop === null) {
  console.log('Отменено пользователем!');
} else if (credits > pricePerDroid) {
  totalPrice = pricePerDroid * shop;
}
...
if (totalPrice > credits) {
  ...
  console.log(
    `Вы купили ${shop} дроидов, на счету осталось ${creditBalance} кредитов.`,
  );
}
